...
def build_prompt0_v4(payload: Dict[str, Any], principles_zh: str) -> Dict[str, Any]:
    """V4：中文原则 + 输入参数 组装 LLM 的系统提示（prompt0）。
    与 v3 相比，强调背景纯白与更强的“信息图禁止”约束。
    """
    ...
    prompt0_text = (
        ...
        "2) Provide a concise set of constraints tailored to the above inputs and principles (not boilerplate). Must include pure white background and forbid infographic-style verbose callouts.\n"
